...
export V_CONFIG=/shares/P2P/tools/medusa
export V_DATA=/shares/P2P/tools/medusa/data
export V_TVSHOWS_DIR=/shares/Data/Series
export V_POST_PROCESSING_DIR=/shares/P2P/complete/medusa
...
export E_TORRENT_LABEL=medusa

# Comment proxy port var to disable use of proxy for searches and indexers in Medusa
...
export CONTAINER_NAME=medusa
export IMAGE_NAME_1=arm-medusa
export IMAGE_NAME_2=ahuh/arm-medusa
export IMAGE_NAME=
